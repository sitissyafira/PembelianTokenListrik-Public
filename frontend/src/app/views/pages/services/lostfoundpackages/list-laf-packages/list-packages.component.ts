...
import { PackagesDeleted, PackagesPageLafRequested, PackagesPageRequested } from '../../../../../core/services/packages/packages.action';
...
export class ListLostFoundPackagesComponent implements OnInit, OnDestroy {
	file;
	...
	ngOnInit() {
		...
		this.subheaderService.setTitle('Lost And Found');
	...
	loadPackagesList() {
		...
		this.store.dispatch(new PackagesPageLafRequested({ page: queryParams }));
		this.selection.clear();
	}
