...
export class LayoutConfig {
	public defaults: LayoutConfigModel = {
		...
		self: {
			...
			logo: {
				dark: "./assets/media/logos/logo-light-bms.png",
				light: "./assets/media/logos/logo-light-bms.png",
				brand: "./assets/media/logos/logo-light-bms.png",
				green: "./assets/media/logos/logo-light-bms.png",
			},
		},
